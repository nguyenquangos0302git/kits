...
<c:url var="LISTurl" value="/admin-slide" />
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
...
<body>
							...
							<div class="card-body">
								<div class="row">
									<div class="col-4">
											...
											<input type="text" class="form-control" name="textSearch" id="textSearch" value="${slide.textSearch}"
												placeholder="Search..." />
									</div>
	...
	<script>
		...
		function deleteSlide(data) {
			$.ajax({
				url: '/model/api-admin/slide/delete',
				type: 'POST',
				contentType: 'application/json',
				data: JSON.stringify(data),
				dataType: 'text',
