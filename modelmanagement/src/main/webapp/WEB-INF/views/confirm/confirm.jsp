		...
		<tr>
			<td bgcolor="#f4f4f4" align="center"
				...
				<table border="0" cellpadding="0" cellspacing="0" width="100%"
					...
					<tr>
						<td bgcolor="#ffffff" align="left"
							...
							<p style="margin: 0;">We're excited to have you get started.
								First, you need to confirm your account. Just press the button
								below.</p>
						</td>
					</tr>
					...
					<tr>
						<td bgcolor="#ffffff" align="left"
							style="color: #666666; font-family: 'Lato', Helvetica, Arial, sans-serif; font-size: 18px; font-weight: 400; line-height: 25px; display: flex; justify-content: center;">
							<input type="text"
							style="display: inline-block; width: 65%; padding: 20px 20px;">
						</td>
					</tr>
					...
					<tr>
						<td bgcolor="#ffffff" align="left"
							...
							<p style="margin: 0; text-align: center;">
								You don't have code in your mail ? <a href="#"> Send Again </a>
							</p>
						</td>
					</tr>
