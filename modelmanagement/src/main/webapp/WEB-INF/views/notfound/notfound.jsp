...
<body>
	...
	<main style="width: 80%;margin-left: 280px;">


		<div class="notfound-page"
			style="width: 38%; display: inline-block; float: left;">
			<svg style="visibility: visible;" version="1.1"
		...
		<div class="notfound-text" style="width: 40%; display: inline-block;">
			<h1>404</h1>
			...
			<p>The page you are looking for does not exist. How you got here
				...
				homepage.</p>
			<a href="<c:url value="/"/>"><button class="btn green">HOME</button></a>
		</div>
	</main>
	<script
...
<!-- <error-page>
	  ...
	  <location>/WEB-INF/views/notfound/notfound.jsp</location>
	</error-page> -->